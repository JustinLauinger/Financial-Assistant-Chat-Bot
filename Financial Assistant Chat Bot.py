...
openai.api_key = open(r"C:/Users/justi/Music/Finance project/API_KEY", "r").read()
...
if user_input:
    try:
        ...
        if response_message.get('function_call'):
            ...
            args_dict = {'ticker': function_arguments.get('ticker')}
            if function_name in ['calculate_SMA', 'calculate_EMA']:
                args_dict['window'] = function_arguments.get('window')
...
new_title = '<p style="font-family:sans-serif; color:gray; font-size: 24px;">Try "Whats current stock price of META" </p>'
next_title = '<p style="font-family:sans-serif; color:gray; font-size: 24px;">Try "Plot the stock of APPLE" </p>'
break_line = '<br>'
